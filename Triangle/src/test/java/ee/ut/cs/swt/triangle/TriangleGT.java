...
public class TriangleGT {
	...
	public void testIsEquilateralAndSetSideLengthsAndSetSideLengthsReturningTriangleWhereIsIsoscelesIsFalse() throws Throwable {
	    ...
	    assertEquals("1886,-3251,1121", triangle0.getSideLengths());
	...
	public void testClassifyAndSetSideLengthsAndSetSideLengthsReturningTriangleWhereIsIsoscelesIsTrue() throws Throwable {
	    ...
	    triangle0.classify();
	    assertEquals("1886,1886,231", triangle0.getSideLengths());
	}

	@Test(timeout = 4000)
	public void testGetPerimeter() throws Throwable {
	    Triangle triangle0 = new Triangle((-392), (-392), 0);
	    triangle0.setSideLengths(1379, 1379, 1379);
	...
	public void testIsImpossible1() throws Throwable {
	    ...
	    boolean boolean0 = triangle0.isImpossible();
	    assertTrue(boolean0);
	    assertEquals("2,-434,-434", triangle0.getSideLengths());
	}
	...
	public void testCreatesTriangleAndCallsIsIsosceles() throws Throwable {
	    ...
	    assertTrue(boolean0);
	    assertEquals((-330), triangle0.getPerimeter());
	}
	...
	public void testIsIsosceles2() throws Throwable {
	    ...
	    boolean boolean0 = triangle0.isIsosceles();
	    assertTrue(boolean0);
	    assertEquals("-4391,-4391,-4391", triangle0.getSideLengths());
	}
	...
	public void testClassifyAndSetSideLengths1() throws Throwable {
	    ...
	    triangle0.setSideLengths(324, 1244, 3740);
	    triangle0.classify();
	    assertEquals("324,1244,3740", triangle0.getSideLengths());
	}
	...
	public void testIsScalene() throws Throwable {
	    ...
	    boolean boolean0 = triangle0.isScalene();
	    assertEquals("-4391,871,-2144463548", triangle0.getSideLengths());
	    assertTrue(boolean0);
	}
	...
	public void testIsScalene0() throws Throwable {
	    ...
	    boolean boolean0 = triangle0.isScalene();
	    assertFalse(boolean0);
	    assertEquals("-19,-423,-423", triangle0.getSideLengths());
	}
	...
	public void testClassify1() throws Throwable {
	    ...
	    assertEquals(1891, triangle0.getPerimeter());
	}
	...
	public void testClassify() throws Throwable {
	    ...
	    triangle0.classify();
	    assertEquals(2799, triangle0.getPerimeter());
	}
	...
	public void testIsScaleneAndSetSideLengthsAndSetSideLengthsReturningTriangleWhereIsEquilateralIsTrue() throws Throwable {
	    Triangle triangle0 = new Triangle((-4372), (-4372), (-4372));
	    triangle0.setSideLengths((-4372), (-949), (-4372));
	    boolean boolean0 = triangle0.isScalene();
	    assertEquals((-9693), triangle0.getPerimeter());
	    assertFalse(boolean0);
	}
